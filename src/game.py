...
class Game(object):
    ...
    def render(self):
        ...
        self.screen.blit(pygame.transform.scale(self.assets.sprites['backgroundday'],(self.screen.get_rect().width,self.screen.get_rect().height)),(0,0),self.screen.get_rect())
